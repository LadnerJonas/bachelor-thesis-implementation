...
template<typename T>
void process_morsels(MorselManager<T>& morsel_manager, PartitionManager<T>& global_partition_manager) {
...
template void process_morsels<int>(MorselManager<int>& morsel_manager, PartitionManager<int>& global_partition_manager);
