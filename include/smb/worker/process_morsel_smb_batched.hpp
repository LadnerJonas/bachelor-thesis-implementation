...
void process_morsel_smb_batched(BatchedTupleGenerator<T> &tuple_generator, OnDemandPageManager<T, partitions, page_size> &page_manager, const size_t num_threads) {
