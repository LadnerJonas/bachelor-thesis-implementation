...
void process_morsel_smb(MorselCreator<T> &morsel_creator, OnDemandPageManager<T, partitions, page_size> &page_manager, const size_t num_threads) {
    const static auto total_buffer_size = 128 * 1024 / (sizeof(T) * num_threads);
