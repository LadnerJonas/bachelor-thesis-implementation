...
TEST(OnDemandPageManagerTest, BasicInsertionsTuple4) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple4, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BasicInsertionsTuple16) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple16, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BasicInsertionsTuple100) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple100, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BasicInsertionsTuple4WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple4, partitions, page_size> page_manager;

    constexpr auto max_tuples_per_page = ManagedSlottedPage<Tuple4>::get_max_tuples(page_size);
...
TEST(OnDemandPageManagerTest, BasicInsertionsTuple16WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple16, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BasicInsertionsTuple100WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple100, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionsTuple4) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple4, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionsTuple16) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple16, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionsTuple100) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple100, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionTuple4WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple4, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionTuple16WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple16, partitions, page_size> page_manager;

    constexpr auto max_tuples_per_page = ManagedSlottedPage<Tuple16>::get_max_tuples(page_size);
    constexpr auto tuples_to_write_per_page = max_tuples_per_page + 32 - (max_tuples_per_page % 32);
...
TEST(OnDemandPageManagerTest, BatchedInsertionTuple100WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple100, partitions, page_size> page_manager;

    constexpr auto max_tuples_per_page = ManagedSlottedPage<Tuple100>::get_max_tuples(page_size);
    constexpr auto tuples_to_write_per_page = max_tuples_per_page + 32 - (max_tuples_per_page % 32);
...
TEST(OnDemandPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple4) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple4, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple16) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple16, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple100) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple100, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple4WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple4, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple16WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple16, partitions, page_size> page_manager;
...
TEST(OnDemandPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple100WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandPageManager<Tuple100, partitions, page_size> page_manager;
