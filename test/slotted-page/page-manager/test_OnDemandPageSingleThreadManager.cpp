...
TEST(OnDemandSingleThreadPageManagerTest, BasicInsertionsTuple4) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple4, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BasicInsertionsTuple16) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple16, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BasicInsertionsTuple100) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple100, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BasicInsertionsTuple4WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple4, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BasicInsertionsTuple16WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple16, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BasicInsertionsTuple100WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple100, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple4) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple4, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple16) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple16, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple100) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple100, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple4WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple4, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple16WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple16, partitions, page_size> page_manager;
...
TEST(OnDemandSingleThreadPageManagerTest, BatchedInsertionWithBatchedWriteoutTuple100WithMultiplePages) {
    constexpr unsigned page_size = 5 * 1024;
    constexpr unsigned partitions = 32;
    OnDemandSingleThreadPageManager<Tuple100, partitions, page_size> page_manager;
