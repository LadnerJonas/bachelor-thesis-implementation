...
void benchmark_RadixOrchestrator() {
    ...
    for (unsigned tuples_to_generate = tuples_base * tuple_count_factor; tuples_to_generate <= 2 * tuples_base * tuple_count_factor; tuples_to_generate += tuples_base * tuple_count_factor) {
