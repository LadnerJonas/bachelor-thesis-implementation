...
int main() {
    ...
    for (unsigned tuples_to_generate = 40'000'000u; tuples_to_generate <= 40'000'000u; tuples_to_generate *= 10) {
        params.setParam("A-Benchmark tuple-materialization", "ContinuousMaterialization");
        tuples_to_generate = static_cast<unsigned>(static_cast<double>(tuples_to_generate) * get_tuple_num_scaling_value<Tuple16>());
        ...
        tuples_to_generate = static_cast<unsigned>(static_cast<double>(tuples_to_generate) * get_tuple_num_scaling_value<Tuple100>());
        params.setParam("B-Tuples", tuples_to_generate);
        ...
        tuples_to_generate = static_cast<unsigned>(static_cast<double>(tuples_to_generate) * get_tuple_num_scaling_value<Tuple4>());
        params.setParam("B-Tuples", tuples_to_generate);
